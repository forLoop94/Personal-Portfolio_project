const reservedProjects = [
  {
    ...
    technologies: {
      tech1: 'Rails | Ruby',
      tech2: 'Css',
      tech3: 'Devise | Cancancan |',
    },
    'Link to live version': 'https://recipe-app-my.onrender.com/',
    'Link to source': 'https://github.com/ankitt26/Recipe-app',
  },
  {
    name: 'To-do list',
    description:
  ...
  },
  {
    name: 'Thrifty',
    description:
      'Thrifty is full-stack budget app that helps users keep track of their daily expenses. The See source button will take you to GitHub where you can read more about this project.',
    'Featured image': {
      mobile: {
